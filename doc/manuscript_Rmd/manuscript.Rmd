...
vignette: >
    %\VignetteIndexEntry{A toy manuscript to demonstrate how to create a computationally reproducible manuscript}
...
This manuscript is an entirely computationally reproducible manuscript. The
...
This manuscript was created as an exercise of the git skills that we have learned
over the past few days and as a demonstration of how those skills can be used
to improve scientific workflows.
...
**Our data set comprises `r dim(simulated_data)[1]`  samples in 
